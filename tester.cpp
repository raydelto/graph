...
Vertex v1 = Vertex("Dalhousie");
Vertex v2 = Vertex("Moncton");
Vertex v3 = Vertex("Woodstock");
Vertex v4 = Vertex("Maine");
Vertex v5 = Vertex("Springfield");
Vertex v6 = Vertex("Boston");
Vertex v7 = Vertex("Fredericton");
Vertex v8 = Vertex("EelRiverBar");
